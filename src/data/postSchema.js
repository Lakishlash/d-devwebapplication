// src/data/postSchema.js
// Single source of truth for labels, placeholders, and limits
// Updated to include the new TUTORIAL post type (no breaking changes)
    ...
    common: {
        title: {
            ...
            placeholders: {
                ...
                [POST_TYPES.TUTORIAL]: "Enter a descriptive title",
            },
        },
        tags: {
            label: "Tags",
            helper: "Please add up to 3 tags to describe the topic (e.g., Java)",
        },
    },
